	...
	*/
	...
	/* array_bubble_sorting_algorithm.cpp */

#include<iostream>
#include"array_bubble_sorting_algorithm.h"
...
int main(){
    ...
    cout << endl;
    cout << "This is program which demonstrates the bubble sorting algorithm using arrays." << endl;
    cout << endl;
